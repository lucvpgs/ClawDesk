...
## ✨ Features noi — Medium impact

| # | Item | Status |
|---|------|--------|
| 1 | **Mobile responsive** — UI arată prost pe telefon; util pentru acces via Tailscale | 🔲 Todo |
| 2 | **Dark/light theme toggle** — momentan forțat dark | 🔲 Todo |
| 3 | **Skill management page** — pagină dedicată skill-uri instalate | 🔲 Todo |
| 4 | **Multi-runtime** — conectare la mai multe instanțe OpenClaw simultan | 🔲 Todo |
| 5 | **Dashboard customizabil** — widgets pe Overview reordonate sau ascunse | 🔲 Todo |
...
| # | Item | Status |
|---|------|--------|
| 1 | **DMG installer** — distribuție simplă; drag to Applications | 🔲 Todo |
| 2 | **Webhook inbound** — events de la OpenClaw prin WebSocket în loc de polling la 5s | 🔲 Todo |
| 3 | **iOS/iPadOS app** — Tauri suport experimental iOS | 🔲 Todo |
