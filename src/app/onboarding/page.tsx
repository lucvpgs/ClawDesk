...
import { Zap, Search, CheckCircle, XCircle, Loader2, ChevronRight } from "lucide-react";
import { cn } from "@/lib/utils";
import type { ScanResult } from "@/types";

type Step = "scan" | "confirm" | "manual" | "connecting" | "done" | "error";
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          ...
          {step === "done" && (
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <div className="text-sm text-zinc-100 font-medium">Connected!</div>
              <div className="text-xs text-zinc-500">Redirecting to Overview...</div>
            </div>
          )}
